                    ...
                    <Grid item xs={12} sm={12} md={7}>
                        <Paper className={classes.paper}>
                            <Box className={classes.box}>
                                ...
                                <Typography className={classes.middleText} variant="h2" align="left">
                                ...
                                <NavLink to="/about">
                                    <Button variant="outlined" color="primary" className={classes.buttonAbout} >
                                        Sobre Mí
                                    </Button>
                                </NavLink>
                                <NavLink to="/proyect">
                                    <Button variant="outlined" color="primary" className={classes.buttonProyect} >
                                        Proyectos
                                    </Button>
                                </NavLink>
                            </Box>
